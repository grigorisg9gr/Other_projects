...
conf = cv(conf, 'training.interval_fg', 2);
conf = cv(conf, 'training.interval_bg', 2);


% -------------------------------------------------------------------
% Evaluation configuration 
% -------------------------------------------------------------------
conf = cv(conf, 'eval.interval', 4);
